...
image_name = 'bearing_dataset_comb'
source_image_dir = './bearings_concat/'
destination_dir = './bearings_concat/'
...
directory_list = [source_image_dir, './predicted_masks_bearings/', './combined_overlays_bearings/']
concat_lists(image_list, directory_list, './multi_concat/', pad=True, orientation=2)


concat_obj = concat('./multi_concat/', destination_dir, image_list_dir, 'bearing_dataset_multi', dim1, dim2)
concat_obj.concat_images(True)
'''